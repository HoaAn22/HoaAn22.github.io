Xây dựng trang web chia sẻ kiến thức về Data Science (Nội dung đang được cập nhật)
...
3. lập trình
	...
	* Hệ cơ sở dữ liệu
	* Mạng máy tính
	* Giải thuật và tối ưu hoá phân tán
	* An toàn thông tin
4. tài chính
	* Kỹ thuật tài chính
...
5. Nghiên cứu khoa học
	...
	* Bài báo khoa học - Khoa học dữ liệu
	* Bài báo khoa học - Tài chính
6. DA
    * Tư duy dữ liệu
...
9. Dev
	...
	* công nghệ phần mềm
	* công nghệ mới
10. Công cụ cho Khoa học dữ liệu
    * Ngôn ngữ lập trình
