...
* Hiểu được các khái niệm về tỷ giá hối đoái giao ngay, tỷ giá hối đoái kỳ hạn
* Công thức tính liên quan đến tăng/giảm giá của tiền tệ
* Hiểu được cách mà 1 quốc gia có thể thực hiện để giảm thâm hụt thương mại và hấp thụ
* Nắm được các khái niệm, thuật ngữ và định nghĩa liên quan đến đến các chế độ tỷ giá hối đoái khác nhau mà các quốc gia có thể áp dụng.

# Chương 1: Tỷ giá ngoại hối

## Giải thích một số khái niệm trong chương này (\*)

* **CPI** (Consumer Price Index - Chỉ số giá tiêu dùng) là một chỉ số đo lường sự thay đổi trung bình về giá của **hàng hóa và dịch vụ** tiêu biểu mà các hộ gia đình tiêu dùng theo thời gian. CPI được sử dụng rộng rãi để theo dõi **lạm phát** và là một chỉ báo quan trọng trong việc đánh giá sức mua của một loại tiền tệ và sự thay đổi trong chi phí sinh hoạt.
...
* **Giao dịch đầu cơ**: trong thị trường ngoại hối là khi 1 cá nhân hoặc tổ chức nhằm kiếm lợi từ sự thay đổi tỷ giá ngoại tệ. Là hành vi dự đoán giá trị tăng hay giảm trong tương lai, từ đó thực hiện các hiện giao dịch để thu lợi từ giao dịch đó. khi dự đoán tăng thì họ sẽ ra quyết định mua và ngược lại.
* **Vị thế đầu cơ** là khái niệm mô tả trạng thái mở của một giao dịch mà nhà đầu tư đang nắm giữ.
...
Có thể hiểu một cách khác là giá hoặc chi phí của đơn vị tiền tệ này theo 1 đơn vị tiền tệ khác[1].
...
**VD**: Trong báo giá 1.25 USD/EUR, USD là đồng tiền định giá và EUR là đồng tiền cơ sở. Giá của một euro (đồng tiền cơ sở) là 1.25 USD (đồng tiền định giá), do đó 1.25 là giá của một đơn vị đồng tiền cơ sở tính theo đơn vị của đồng tiền khác.

***Lưu ý***: Đôi khi tỷ giá được thể hiện dưới dạng **Price Currency/Base Currency** được gọi là báo giá trực tiếp với nhà đầu tư ở quốc gia có đồng định giá (**Price Currency**) và là báo giá gián tiếp với nhà đầu tư ở quốc gia có đồng tiền cơ sở (**Base Currency**).
### Công thức tỷ giá thực tế
...
Trong đó:
* Tỷ giá hối đoái thực tế (RER-real exchange rate) là tỷ giá đã điều chỉnh bởi giá tương đối của hàng hóa và dịch vụ trong và ngoài nước, thể hiện sự cạnh tranh của một quốc gia so với thế giới[3].
* Tỷ giá hối đoái danh nghĩa (nominal exchange rate)
* CPI: Chỉ số giá tiêu dùng (*)

Tỷ giá hối đoái thực tế phản ánh sức mua của đồng tiền trong nền kinh tế, cho thấy khả năng cạnh tranh của hàng hóa và dịch vụ giữa các quốc gia.

**Tại sao lại có tỷ giá danh nghĩa và thực tế?** : 
* Tỷ giá hối danh nghĩa không đủ để đánh giá khả năng cạnh tranh của một quốc gia về hàng hóa và dịch vụ, trong khi tỷ giá hối đoái thực tế được điều chỉnh dựa trên **CPI** có thể đánh giá sức cạnh tranh của quốc gia đó. 
* Tỷ giá thực tế là một chỉ số cần thiết để cho chính phủ và các nhà đầu tư ra được các quyết định quan trọng như đầu tư, xuất/nhập khẩu và đưa ra chính sách tiền tệ.

**VD**: Trong giai đoạn cơ sở, CPI của Mỹ và Anh đều là 100, tỷ giá 1,7 USD/GBP(bảng Anh). Sau 3 năm, tỷ giá lúc này là 1,6 USD/GBP, CPI của Mỹ và của Anh lần lượt là 110 và 112. **Lưu ý trong ví dụ này là báo giá trực tiếp**.
...
*Ví dụ: một công ty đầu dự kiến sẽ đầu tư 1 Triệu USD vào 1 quốc gia với thời gian 90 ngày để hoàn tất thủ tục. Trong khoảng thời gian này họ có thể phải gặp rủi ro về việc giảm tỷ giá. Bằng cách ký kết họp đồng kỳ hạn 90 ngày, công ty đã có thể giảm bớt được rủi này*. **Bảo hiểm rủi ro**(*).
...
[3]Những người đóng góp vào các dự án Wikimedia, “tỉ giá mà một loại tiền tệ sẽ được trao đổi với loại tiền tệ khác,” _Wikipedia.org_, Sep. 07, 2006. https://vi.wikipedia.org/wiki/T%E1%BB%B7_gi%C3%A1_h%E1%BB%91i_%C4%91o%C3%A1i (accessed Sep. 25, 2024).