...
* **CPI** (Consumer Price Index - Chỉ số giá tiêu dùng) là một chỉ số đo lường sự thay đổi trung bình về giá của **hàng hóa và dịch vụ** tiêu biểu mà các hộ gia đình tiêu dùng trong thời gian. CPI được sử dụng rộng rãi để theo dõi **lạm phát** và là một chỉ báo quan trọng trong việc đánh giá sức mua của một loại tiền tệ và sự thay đổi trong chi phí sinh hoạt.
