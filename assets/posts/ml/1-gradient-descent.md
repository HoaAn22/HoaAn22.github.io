...
* Đối với các mô hình như Deep learning phức tạp, phải xử lý dữ liệu ma trận nhiều, việc tối ưu được các siêu tham số cho mô hình này vô cùng khó gần như không thể với các phương pháp truyền thống. Đối với các thuật toán tối ưu sẽ tìm được tham số sấp sỉ **(được xem là kết quả)**. Các siêu tham số của mô hình sẽ dựa trên **tốc độ học (learning rate)** tốc độ càng nhỏ các siêu tham số càng sát với dữ liệu.
